...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("backend.Models.Admin.ChotCa", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<double?>("TienDauCa")
                        .HasColumnType("float");

                    b.Property<double?>("TienMatThucTe")
                        .HasColumnType("float");

                    b.Property<double>("TongThuTienMat")
                        .HasColumnType("float");

                    b.Property<double>("TongThuVNPAY")
                        .HasColumnType("float");
            ...
            modelBuilder.Entity("backend.Models.Admin.TaiKhoanNoiBo", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            GioiTinh = false,
                            IsActive = true,
                            MatKhau = "$2a$11$LQW8IdjKdClXmmxWb7EIAeT5OoIk3tqyynO2290d9o1.U4CgUEn52",
            ...
            modelBuilder.Entity("backend.Models.Client.Order", b =>
                {
                    ...
                    b.Property<string>("LalamoveOrderId")
                        .HasMaxLength(100)
                        .HasColumnType("nvarchar(100)");

                    b.Property<string>("LalamoveQuotationId")
                        .HasMaxLength(100)
                        .HasColumnType("nvarchar(100)");

                    b.Property<string>("LalamoveTrackingUrl")
                        .HasMaxLength(500)
                        .HasColumnType("nvarchar(500)");
            ...
            modelBuilder.Entity("backend.Models.Admin.ChamCong", b =>
                {
                    b.HasOne("backend.Models.Admin.CaLamViec", "CaLamViec")
                        .WithMany()
